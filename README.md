...
**[React-BookStore]** In this project user can add and delete Books and Books are stored in the browser.
...
- **[Use React to create a Bookstore]**
- **[Install React Router]**
- **[Build Home Component]**
- **[Setup router inside of App]**
...
```sh
  cd my-folder
  git clone https://github.com/yusufobr/book-store.git
```
...
This project is [MIT](https://github.com/yusufobr/book-store/blob/dev/LICENSE) licensed.
